...
ROLE_RISKS: dict[str, str] = {
    ...
    "infra": "declared substrate only; per-repo AGENTS.md is load-bearing",
...
def main() -> int:
    ...
    print(
        ...
        "see docs/schemas/tinyland-repo-manifest.schema.json (v1) or "
        "docs/schemas/tinyland-repo-manifest.v2.schema.json (v2).",
        file=sys.stderr,
    )
