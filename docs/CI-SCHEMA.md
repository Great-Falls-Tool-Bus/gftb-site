...
The generic `tofu/` composition is not an application apply plane. It consumes
SemVer-pinned GloriousFlywheel modules for cache quota and runner binding. It
does not install PR DNS, an application receiver, or the retired
