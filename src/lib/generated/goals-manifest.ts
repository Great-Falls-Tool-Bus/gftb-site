...
export const publishedGoalEntries: GeneratedGoalEntry[] = [
	...
	},
	{
		...
		text: "Learn to model beautiful CAD, draft real cut lists and BOMs, and build the thing you drew. Be first to sign up for Jess's acclaimed Fusion 360 workshop series, now with 50% more LaTeX markup.",
		sourcePath: 'src/content/goals/63-fusion-workshop.md',
	},
	{
	...
	{
		slug: '91-invite-work-and-learn',
		metadata: {
			kind: 'goal',
			order: 91,
			title: 'Work and learn together! Hop on the Great Falls Tool Bus',
			cta_label: 'Join us',
			cta_href: '/contact',
			published: true,
		},
		text: '',
		sourcePath: 'src/content/goals/91-invite-work-and-learn.md',
	},
	{
		slug: '92-invite-take-a-ride',
		metadata: {
			kind: 'goal',
			order: 92,
		...
		text: '',
		sourcePath: 'src/content/goals/92-invite-take-a-ride.md',
	},
	{
		slug: '93-invite-share-the-love',
		metadata: {
			kind: 'goal',
			order: 93,
			title:
				"Have a tool that you don't use often? Want a tool for a special project? Join the Great Falls Tool Bus and share the love",
			cta_label: 'Join us',
			cta_href: '/contact',
			published: true,
		},
		text: '',
		sourcePath: 'src/content/goals/93-invite-share-the-love.md',
	},
	{
		slug: '94-invite-winter-sport',
		metadata: {
			kind: 'goal',
			order: 94,
			title: 'Try out a new winter sport this season by joining the Great Falls Tool Bus',
			cta_label: 'Join us',
			cta_href: '/contact',
			published: true,
		},
		text: '',
		sourcePath: 'src/content/goals/94-invite-winter-sport.md',
	},
];
