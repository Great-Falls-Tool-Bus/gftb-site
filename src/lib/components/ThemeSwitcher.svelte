...
>
	...
	<Portal>
		<!-- Tooltip tier, not dropdown tier: this switcher also mounts inside the
		     mobile drawer (z-modal on the semantic scale in app.css), and the
		     portaled popover must clear the drawer to stay visible and clickable. -->
