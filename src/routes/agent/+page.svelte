<script lang="ts">
	...
	const entrypoints = [
		...
		},
		{
			...
			text: 'Lane metadata, Flywheel, runner, and conformance schema.',
		},
		{
		...
		},
		{
			...
			text: 'Static spoke, app spoke, mothership, owner-overlay, substrate, and GloriousFlywheel boundaries.',
		},
		{
			label: 'Justfile',
...
<main class="mx-auto max-w-5xl px-6 py-16 md:py-20">
	<div class="max-w-3xl">
		<!-- Reference usage of the shared PageHeader: the eyebrow -> h1 -> lead
		     block plus the auto-rendered view/edit-source affordance (SourceLink). -->
		<PageHeader
			eyebrow="Agent AX"
			title="site.scaffold traversal map"
			lead="The scaffold is itself a static spoke: public site, machine-readable index, reusable project skills, and a single Justfile-backed command surface."
		/>
	</div>
