...
5. `docs/CI-SCHEMA.md` before CI, lane, Tofu, or Flywheel changes
...
- MassageIthaca-shaped app repos may own runtime behavior, while their
  dedicated owner overlays own state, apply, PR lifecycle, and runtime
  receipts. Generic lane metadata and Flywheel contracts remain reusable.
- The scaffold has no application/PR receiver, sender, reaper, or public-preview
  authority. A generic substrate does not acquire product ownership by hosting
  the workload.
